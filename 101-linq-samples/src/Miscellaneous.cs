...
namespace Try101LinqSamples
{
    ...
    #region custom-sequence-operator
    public static class CustomSequenceOperators
    {
        public static IEnumerable<TResult> Combine<TSource, TResult>(this IEnumerable<TSource> first,
            IEnumerable<TSource> second,
            Func<TSource, TSource, TResult> func)
        {
            using (IEnumerator<TSource> e1 = first.GetEnumerator(), e2 = second.GetEnumerator())
            {
