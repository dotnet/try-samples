...
namespace Try101LinqSamples
{
    ...
    {
        #region XML_DATA // You don't really want to see this.
        private const string customers_xml =
@"<?xml version=""1.0""?>
<customers>
  <customer>
    <id>ALFKI</id>
  ...
  <customer>
    ...
    <orders>
      ...
      <order>
        ...
        // TODO: Change to load from string stream:
        private List<Customer> customerList = (from e in XDocument.Parse(customers_xml).
